...
pathApsim <- "C:/Program Files (x86)/Apsim78-r3867/Model/Apsim.exe"

# .apsim files path
pathSim <- "D:/Documentos/Pesquisa/Projetos/futureSugar/data/apsim/"

# .out files path
pathOut <- "D:/Documentos/Pesquisa/Projetos/futureSugar/data/apsim-out/"
